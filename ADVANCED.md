...
売上課題では、木は深さ20で**48本の枝**に分かれました。しかし14回のフル回答を読むと、**13回までが同じ提案（時系列分析）の言い回し違い**で、例外は1回だけ。「48本の枝のうちどれとどれが同じ意味か」を木は教えてくれません。その**意味の束ね**を担うのが hidden state 空間です——右図のとおり、全文の hidden state を見れば、読まずに「ほぼ全員同じことを言っている＋例外1」が分かります。
