...
for q in QS:
    ...
    ax.annotate(qja[q], (cx, cy), fontsize=11.5, weight="bold",
                ...
                ha="center", zorder=5)
sf_c = xy[[i for i, x in enumerate(qids) if x == "sf07"]].mean(0)
ax.annotate("割れている！", xy=(sf_c[0], sf_c[1]), xytext=(70, -55),
            textcoords="offset points", fontsize=13, color="#a33", weight="bold",
